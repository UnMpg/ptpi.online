                ...
                <div class="well-middle">
                    <div class="single-well">
                        ...
                        <p style="text-align: justify;">
                            {{ trans('lang.INTRODUCTION_CONTENT') }} <br><br>
            ...
            <div class="row">
                ...
                <a href="#">13 comments</a>
                            ...
                            <span class="date-type">
                                ...
                                <?= date("d F Y H:i:s", strtotime($b['brt_datecreated'])); ?>
                            </span>
                        </div>
                        <div class="blog-text">
                            <h4>
                    ...
                    <div class="single-blog">
                        <div class="single-blog-img">
                            <a href="<?= base_url('artikel/detail/') . $a['art_id']; ?>">
                                <img src="<?= base_url('assets/img/artikel/') . $a['art_img']; ?>" alt=""
                                    style="border-radius: 25px;">
                            </a>
                        </div>
                        <div class="blog-meta">
                            <span class="date-type">
                                <i class="fa fa-calendar"></i>
                                <?= date("d F Y H:i:s", strtotime($a['art_datecreated'])); ?>
                            </span>
                        </div>
                        <div class="blog-text">
                            <h4>
        ...
        <div class="row">
            <div class="col-md-4 col-sm-4 col-xs-12">
                <div class="single-blog">
                    ...
                    <div class="blog-text">
                        <h4>
                            <a href="http://iahe.or.id/berita/detail/5">Seminar Online HVAC & Ruang Isolasi Di Era "New
                                Normal" </a>
                        </h4>
                    </div>
                </div>
            ...
            <div class="col-md-4 col-sm-4 col-xs-12">
                <div class="single-blog">
                    ...
                    <div class="blog-text">
                        <h4>
                            <a href="http://iahe.or.id/berita/detail/6">Seminar Online Gas Medik & Vakum Medik Di Era
                                "New Normal"</a>
                        </h4>
                    </div>
                </div>
                ...
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <div class="contact-icon text-center">
                        <div class="single-icon">
                            ...
                            <p>
                                Location: Gedung Wisma NH Lantai 1, Jl. Raya Pasar Minggu No.2B-C 2 1 2, RT.2/RW.2,
                                Pancoran, Kec. Pancoran,<br>
