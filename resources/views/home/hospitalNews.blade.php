            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                <div class="page-head-blog">
                    <div class="single-blog-page">
                        <!-- search option start -->
                        <form action="{{ action('HomeController@searchHospitalNews') }}" method="GET">
                        ...
                        <div class="left-blog">
                            ...
                            <div class="recent-post">
                                ...
                                <div class="recent-single-post">
                                    <div class="post-img">
                                        <a href="{{ action('HomeController@showHospitalNews', $new->id) }}">
                                            <img src="{{ asset('assets/news/' . $new->image) }}" alt="">
                                        </a>
                                    </div>
                                    <div class="pst-content">
                                        <p><a href="{{ action('HomeController@showHospitalNews', $new->id) }}">{{ $new->judul }}</a></p>
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="single-blog">
                            ...
                            <div class="blog-text">
                                <h5>
                                    <a href="{{ action('HomeController@showHospitalNews', $new->id) }}">{{ $new->judul }}</a>
                                </h5>
                                <p>
                            ...
                            <span>
                                <a href="{{ action('HomeController@showHospitalNews', $new->id) }}" class="ready-btn">Read
                                    more</a>
                            </span>
                        </div>
                        @endforeach
