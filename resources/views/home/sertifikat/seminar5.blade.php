            ...
            <table class="table-borderless" style="margin-top: 30px; margin-left: 40px; margin-right: 100px;">
                <tbody>
                    <tr>
                        ...
                        <td class="td-7 text-white">
                            <img src="{{ $backgroundEsdm }}" alt="esdm" width="100">
                        </td>
                        <td class="td-5 text-white">
                    ...
                    <tr>
                        ...
                        <td class="td-100" style="text-align: center;">
                            ...
                            <div style="display: block; margin-top: 7px; color: #B22222;">NO:
                                PTPI/2020/09/11-<?= str_pad($order->order, ($order->order > 999) ? 4 : 3, '0', STR_PAD_LEFT); ?>
                            </div>
                            ...
                            <div style="display: block; margin-top: 7px; margin-bottom: 7px;">
                                <b>MASTER PLAN RUMAH SAKIT :
                                    SISTEM KELISTRIKAN RUMAH SAKIT</b>
                            </div>
                            ...
                            <span style="margin-top: 15px;">REPUBLIK INDONESIA pada 11 September 2020, selama 3
                                jam.</span>
                        </td>
                        <!-- <td class="td-20"></td> -->
                    </tr>
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="td-40">
                            ...
                            <div style="text-align: center;">
                                Wahyudi Joko Santoso, ST, MT
                            </div>
                            <div style="text-align: center; margin-top: 5px;">
                                <span>Kepala Subdirektorat Standardisasi Ketenagalistrikan</span>
                            </div>
                        </td>
                    </tr>
                </tbody>
