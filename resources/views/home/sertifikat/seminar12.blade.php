...
<html>
    ...
    <body style="background-image: url('<?= $background ?>'); background-repeat: no-repeat;">
        ...
        <div class="container">
            <br>
            <table class="table-borderless" style="margin-top: 10px; margin-left: 40px; margin-right: 100px;">
                <tbody>
                    <tr>
                        ...
                        <td class="td-7">
                            <img src="{{ $backgroundPtpi }}" style="padding-top: 40px;" alt="logo_ptpi" width="100" height="100" />
                        </td>
                    </tr>
                </tbody>
            </table>
            <table class="table-borderless" style="margin-top: -80px; margin-left: -30px;">
                <tbody>
                    <tr>
                        ...
                        <td class="td-100" style="text-align: center;">
                            ...
                            <div style="display: block; margin-top: 7px; color: #B22222;">NO:
                                PTPI/2020/12/11-<?= str_pad($order->order, ($order->order > 999) ? 4 : 3, '0', STR_PAD_LEFT); ?>
                            </div>
                            ...
                            <div style="display: block; margin-top: 7px;">dalam seminar</div>
                            <div style="display: block; margin-top: 7px; margin-bottom: 7px;">
                                <b>PERENCANAAN SARANA PRASARANA RADIOTERAPI DAN KEDOKTERAN NUKLIR</b>
                            </div>
                            ...
                            <div style="display: block; margin-top: 7px; margin-bottom: 7px;">PERKUMPULAN TEKNIK
                                ...
                                pada 18 Desember 2020, selama 3
                                jam.</div>
            ...
            <br />
           <table class="table-borderless" style="margin-left: -5px; margin-top: -40px;">
                <tbody>
                    <tr>
