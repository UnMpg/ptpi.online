                    ...
                    <tr>
                        ...
                        <td class="td-100" style="text-align: center;">
                            ...
                            <div style="display: block; margin-top: 7px; color: #B22222;">NO:
                                PTPI-KEMENKES/2020/08/07-<?= str_pad($order->order, 3, '0', STR_PAD_LEFT); ?>
                            </div>
                            <div style="margin-top: 3px;"><i>Diberikan kepada:</i></div>
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="td-40">
                            ...
                            <div style="text-align: center; margin-top: 5px;">
                                <span>Plt. Sesditjen Pelayanan Kesehatan Kemenkes</span>
                            </div>
                        </td>
                    </tr>
                </tbody>
