                    ...
                    <tr>
                        ...
                        <td class="td-100" style="text-align: center;">
                            ...
                            <div style="display: block; margin-top: 7px; color: #B22222;">NO:
                                PTPI/2020/10/16-<?= str_pad($order->order, ($order->order > 999) ? 4 : 3, '0', STR_PAD_LEFT); ?>
                            </div>
                            ...
                            <b>PENCEGAHAN & PENANGGULANGAN KEBAKARAN DI RUMAH SAKIT</b>
                            </div>
                            ...
                            <div style="display: block; margin-top: 7px; margin-bottom: 7px;">PERKUMPULAN TEKNIK
                                ...
                                pada 16 Oktober 2020, selama 3
                                jam.</div>
                                <span style="color: #fff">____________________________ ________</span>
                                <span style="color: #fff">____________________________ ________</span>
                            <span style="color: #fff;">___________ ________________</span>
                        </td>
                        <!-- <td class="td-20"></td> -->
                    </tr>
                </tbody>
