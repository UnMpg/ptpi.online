...
<div class="page-view bg-light" >
    <div class="container">
        <div class="text-center">
            ...
            <p>
                LSP TPI berkomitmen menjadi lembaga sertifikasi yang akan terus menjaga kepercayaan industri, pemerintah, dan masyarakat dalam menghasilkan para ahli yang kompeten di bidang pelayanan kesehatan.
