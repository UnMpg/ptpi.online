...
<div class="page-view bg-light" >
    <div class="container">
        <div class="text-center">
            <h2 class="section-heading text-uppercase mb-4">AHLI TEKNIK PELAYANAN KESEHATAN</h2>
            <br>
            <p> Ahli Teknik Pelayanan Kesehatan merupakan orang yang memiliki keahlian dalam melakukan perencanaan, pengembangan, pemilihan, pemantauan operasional dan pemeliharaan, evaluasi, pelatihan dan pengelolaan bangunan, sistem mekanikal, sistem elektrikal, ekologi, sistem informasi, dan peralatan medis rumah sakit. <br> </p>
        </div>
        <br>
        <br>
        <div class="row">
