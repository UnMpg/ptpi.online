...
<div class="page-view bg-light" >
    <div class="container">
        ...
        <div class="row">
            ...
            <p> 4. Tidak bertindak dengan cara apapun yang merugikan reputasi atau profesionalisme Ahli Teknik sesuai dengan ruang lingkup yang dipilih</p>
            <p> 5. pelaporan sistem LSP PTPI setiap 1 tahun sekali dengan laporan berupa rincian rencana kerja dan pencapaian harian, mingguan, bulanan dan tahunan dari kegiatan yang sesuai dengan ruang lingkup sertifikasi nya            </p>
        ...
        <div class="row">
            ...
            <p> 4. Didaftarkan sebagai peserta pemegang sertifikasi keahlian bidang yang dipilih (Opsi).</p>
