...
<script>
    ...
    $('.add_notive').change(function(){
        ...
        lulus_verifikasi = `<p>Kepada Yth, <strong> ${hasil_data}</strong></p><p>Berdasarkan hasil verifikasi dokumen/berkas yang diajukan, Selamat anda dinyatakan <strong><em>LULUS</em></strong> tahapan verifikasi dengan potensi level teknik pelayanan kesehatan <strong><em>MUDA</em></strong>.</p><p>Selanjutnya Melakukan Pembayara Rekening berikut :</p><p>Nama : TEKNIK PERUMAHSAKITAN IN</p><p>Nomor Rekening : 5290849995</p><p>Bank : BCA</p><p>Jumlah : RP 6.000.000</p><p>Informasi lebih lanjut dapat menghubungi kami di Siti 082383477128</p><p>Sekian, terimakasih.</p>`;
