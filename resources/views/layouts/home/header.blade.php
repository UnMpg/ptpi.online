<head>
    ...
    <link href="{{ asset('assets/home/vendor/icofont/icofont.min.css') }}" rel="stylesheet">
    <link href="{{ asset('assets/home/vendor/animate.css/animate.min.css') }}" rel="stylesheet">
    <link href="{{ asset('assets/home/vendor/font-awesome/css/font-awesome.min.css') }}" rel="stylesheet">
    <link href="{{ asset('assets/home/vendor/nivo-slider/css/nivo-slider.css') }}" rel="stylesheet">
    <link href="{{ asset('assets/home/vendor/owl.carousel/assets/owl.carousel.min.css') }}" rel="stylesheet">
    <link href="{{ asset('assets/home/vendor/venobox/venobox.css') }}" rel="stylesheet">
