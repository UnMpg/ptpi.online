            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="section-headline text-center">
                        <img src="{{ asset('assets/sponsor/sponsor.png') }}" alt="sponsor" style="width: 220px; height: 130px;">
                        <img src="{{ asset('assets/sponsor/sponsor1.png') }}" alt="sponsor" style="width: 220px; height: 130px; margin-left: 10px;">
                        <marquee direction="left" class="mt-3">
                           <h5> Sponsor dalam Seminar PTPI Seri 12 : PT. Industri Nuklir Indonesia (Persero) & PT.Medika Abimanyu.</h5>
                        </marquee>
                        <hr>
                        <h2>Pengantar</h2>
                    </div>
